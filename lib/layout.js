...
const { ObjectHash } = require('./helpers');

const INLINE_TAGS = [ 'a', 'b', 'u', 'strong', 'cite', 'code', 'em', 'i', 'q', 'small', 'span', 'sub', 'sup', 'br' ];
const Equals = ( objA, objB ) =>  objA === objB || ( objA && objB && typeof objA === 'object' && typeof objB === 'object' && ObjectHash( objA ) === ObjectHash( objB ));

module.exports = class Layout
{
    #document; #style; #elements = [];

    constructor( document, style, nodes, options )
    {
