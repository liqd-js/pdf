...
const Image = module.exports.Block = class Image extends Element
{
    ...
    constructor( document, style, width, src )
    {
        super( document, style, width );
    ...
    constructor( document, style, width, elements )
    {
        ...
        this.#elements = elements.map( n => 
        {
            if( n.type === 'block' )
            {
                if( n.tag === 'img' )
                {
                    return new Image( document, n.style, this.innerWidth, n.attributes.src );
                }
...
const Grid = module.exports.Grid = class Grid extends Element
{
    ...
    #reflow()
    {
        ...
        for( let row of this.#grid )
        {
            ...
            row.cells.forEach( c => c.block && c.block.resize( this.innerWidth / columns * c.columns, row.height ));
        }
